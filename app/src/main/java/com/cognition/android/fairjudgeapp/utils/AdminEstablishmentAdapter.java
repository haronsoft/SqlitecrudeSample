...
public class AdminEstablishmentAdapter extends RecyclerView.Adapter<AdminEstablishmentAdapter.AdminEstablishmentViewHolder> implements Filterable {
    ...
    public AdminEstablishmentAdapter(Context context, List<Establishment> establishmentList) {
    ...
    @NonNull
    @Override
    public AdminEstablishmentViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                //Inflate admin item
                .inflate(R.layout.item_establishment, parent, false);
        return new AdminEstablishmentViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull final AdminEstablishmentViewHolder holder, int position) {
    ...
    private void setRating(EstablishmentAdapter.EstablishmentViewHolder holder, int rating) {
        switch (rating) {
            case 5:
    ...
    class AdminEstablishmentViewHolder extends RecyclerView.ViewHolder {
        ...
        AdminEstablishmentViewHolder(View itemView) {
            super(itemView);
